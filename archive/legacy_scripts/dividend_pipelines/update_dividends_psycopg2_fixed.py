#!/usr/bin/env python3
"""
Script para atualizar dividendos usando conexão direta PostgreSQL - VERSÃO CORRIGIDA
Conecta diretamente ao Supabase via psycopg2 e executa todas as atualizações
SEM tentar modificar triggers de sistema
"""
...
def execute_dividends_update(conn, etfs_data):
    ...
    try:
        # Processamento direto (sem modificar triggers)
...
def main():
    """Função principal"""
    print("🚀 ETF Curator - Atualização de Dividendos via PostgreSQL (VERSÃO CORRIGIDA)")
    print("=" * 70)
    ...
    try:
        ...
        print("Esta operação irá modificar APENAS as colunas 'dividends_12m' e 'updatedat'.")
        print("Todas as outras colunas permanecerão intactas.")
